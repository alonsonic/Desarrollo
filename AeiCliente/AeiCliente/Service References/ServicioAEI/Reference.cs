...
namespace AeiCliente.ServicioAEI {
    ...
    public interface IServicioAEI {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioAEI/BusquedaProductoAplicacion", ReplyAction="http://tempuri.org/IServicioAEI/BusquedaProductoAplicacionResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<AeiCliente.ServicioAEI.Producto>> BusquedaProductoAplicacionAsync(string busqueda);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<AeiCliente.ServicioAEI.Producto>> BusquedaProductoAsync(string busqueda, int pagina, int numeroArticulo);
    ...
    public partial class ServicioAEIClient : System.ServiceModel.ClientBase<AeiCliente.ServicioAEI.IServicioAEI>, AeiCliente.ServicioAEI.IServicioAEI {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<AeiCliente.ServicioAEI.Producto>> BusquedaProductoAplicacionAsync(string busqueda) {
            return base.Channel.BusquedaProductoAplicacionAsync(busqueda);
        }
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<AeiCliente.ServicioAEI.Producto>> BusquedaProductoAsync(string busqueda, int pagina, int numeroArticulo) {
            return base.Channel.BusquedaProductoAsync(busqueda, pagina, numeroArticulo);
        }
